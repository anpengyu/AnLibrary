...
import com.apy.library.net.net.http.interceptor.HttpHeadInterceptor
import com.apy.library.net.net.http.interceptor.HttpLoggingInterceptor
import com.apy.library.net.net.http.interceptor.NoneInterceptor
import okhttp3.*
